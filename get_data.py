...
def find_news():
    ...
    with open('data.json', 'w') as f:
        for new in news:
            ...
            waktuScraping = current_date + months[current_month-1] + " " + current_year + current_hour + current_minute + current_second
            waktuPublish = new.find('div', class_='date').text.split('-')

            info = {"judul": title, "kategori": categories, "waktu_publish": waktuPublish[1].strip(),
